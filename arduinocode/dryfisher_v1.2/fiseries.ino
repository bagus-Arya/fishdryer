...
void loop() {
  ...
  get_suhu();
  lampu();
  send_data(const char * Celcius, const char * berat);
...
void send_data(const char * suhu, const char * berat){
  SIM900.println(F("AT+CIPSTART=\"TCP\",\"http://203.142.74.174:3280\",80\r\n"));
  delay(2000);
